...
/** "3mo ago" — how long since you last said anything to this person.
 *
 *  Coarse on purpose: the row is deciding whether to write to them now, and
 *  "17 days" vs "19 days" never changes that answer, while "2y" does. */
export function lastSpokeLabel(at: string | null): string | null {
  if (!at) return null;
