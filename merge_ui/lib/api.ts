...
export const api = {
  ...
  createFollowup: (body: { person_id: string; due_date?: string | null; due_time?: string | null; topic?: string | null }) =>
  ...
  bulkPatchFollowups: (
    ids: string[],
    body: { due_date?: string | null; due_time?: string | null; connected?: boolean; status?: string },
  ) =>
