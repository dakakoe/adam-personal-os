    ...
    <AppShell>
      <div className="p-4 sm:p-6 mx-auto w-full max-w-5xl">
        <header className="mb-4 sm:mb-6 flex flex-wrap items-baseline justify-between gap-3">
          ...
          <Link
            href="/cleanup/numbers"
            className="inline-flex items-center gap-1 h-8 px-2.5 rounded-md border border-border text-xs text-muted-foreground hover:text-foreground hover:bg-accent shrink-0"
          >
