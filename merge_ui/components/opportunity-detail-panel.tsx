...
export function OpportunityDetailPanel({
  ...
  const reload = useCallback(async () => {
    ...
    setAwardUsd(d.award_usd != null ? fmtMoneyInput(String(d.award_usd)) : "");
            ...
            <div className="grid grid-cols-[6rem_1fr] gap-y-3 gap-x-3 items-center text-sm">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1">
                  ...
                  <MoneyInput
                    value={awardUsd} onValueChange={setAwardUsd}
                    onBlur={() => {
                      const v = parseMoneyInput(awardUsd);
                      if (v !== (opp.award_usd ?? null)) patch({ award_usd: v });
                    }}
                    placeholder="amount" className="h-8 text-sm w-32"
                  />
                </div>
                <Input
