...
INSERT INTO memory.group_mention (person_id, raw_id, chat_id, handle, occurred_at)
SELECT i.person_id, x.raw_id, x.chat_id, x.handle, x.message_date
  FROM mentioned x
...
ON CONFLICT (person_id, raw_id) DO NOTHING
"""
