...
CIRCLES_DUE_SQL = """
WITH stat AS (
  -- Last contact counts an @mention in a group as contact. It is NOT added
  -- to `total`, which stays a count of real interactions — a mention says
  -- "you spoke", not "you have a deeper relationship".
  SELECT person_id,
